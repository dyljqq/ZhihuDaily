...
class HomeThemeCell: UITableViewCell {
    
    lazy var homeIcon: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "home")!.imageWithRenderingMode(.AlwaysTemplate)
    ...
    lazy var icon: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "switch")!.imageWithRenderingMode(.AlwaysTemplate)
    ...
    private func setup() {
        ...
        self.homeIcon.snp_makeConstraints { make in
        ...
        self.contentLabel.snp_makeConstraints { make in
            make.centerY.equalTo(self.contentView)
            make.left.equalTo(self.homeIcon.snp_right).offset(leftSpace)
        }
